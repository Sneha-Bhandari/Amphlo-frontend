...
export default function PartnerForm() {
  ...
  const [selectedPhoneCountry, setSelectedPhoneCountry] = useState("+977");
  ...
  const handleSubmit = async (values, { resetForm, setSubmitting }) => {
    ...
    try {
      const fullPhoneNumber = `${selectedPhoneCountry}${values.phoneNumber}`;
      const fullWhatsappNumber = `${selectedWhatsappCountry}${values.whatsappNumber}`;
      ...
      toast.success(
        "Partnership request submitted successfully! We'll contact you soon.",
        { id: toastId }
      );
      resetForm();
      setSelectedPhoneCountry("+977");
      setSelectedWhatsappCountry("+977");
    } catch (error) {
          ...
          {partnerSectionData.description && (
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: partnerSectionData.description,
              }}
            />
          )}
        </div>
          ...
          <div className="bg-[#04413D]/20 rounded-3xl shadow-xl p-6 md:p-8 flex flex-col h-full">
            <div className="mb-6">
              ...
              <p className="text-gray-500 text-sm">
                Complete the form below and our partnership team will reach out
                within 24 hours.
              </p>
                ...
                <Form className="space-y-5 flex-1">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="flex flex-col">
                      <label className="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-1">
                        First Name{" "}
                        <span className="text-[#04413D] text-lg">*</span>
                      </label>
                      <div
                        className={`relative transition-all duration-200 ${
                          isFocused.firstName ? "transform scale-[1.01]" : ""
                        }`}
                      >
                        <Field
                          type="text"
                    ...
                    <div className="flex flex-col">
                      ...
                      <div
                        className={`relative transition-all duration-200 ${
                          isFocused.lastName ? "transform scale-[1.01]" : ""
                        }`}
                      >
                        <Field
                          type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="flex flex-col">
                      ...
                      <div
                        className={`relative transition-all duration-200 ${
                          isFocused.country ? "transform scale-[1.01]" : ""
                        }`}
                      >
                        <Field
                          as="select"
                    ...
                    <div className="flex flex-col">
                      ...
                      <div
                        className={`relative transition-all duration-200 ${
                          isFocused.email ? "transform scale-[1.01]" : ""
                        }`}
                      >
                        <Field
                          type="email"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div
                        className={`relative transition-all duration-200 ${
                          isFocused.companyName ? "transform scale-[1.01]" : ""
                        }`}
                      >
                        <Field
                          type="text"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div className="flex flex-col ">
                      <label className="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-1">
                        <FaPhoneAlt className="w-3 h-3 text-[#04413D]" />
                        Phone Number{" "}
                        <span className="text-[#04413D] text-lg">*</span>
                      </label>
                      <div className="flex gap-2">
                        <div className="relative w-24">
                          <select
                            ...
                            onChange={(e) =>
                              setSelectedPhoneCountry(e.target.value)
                            }
                            className="w-full border text-gray-700 border-gray-200 rounded-xl p-2 focus:outline-none focus:border-[#04413D] focus:ring-1 focus:ring-[#04413D] bg-white cursor-pointer appearance-none text-center font-medium text-sm"
                          >
                        ...
                        <Field
                          ...
                          className="flex-1 border border-gray-200 rounded-xl p-1 focus:outline-none focus:border-[#04413D] focus:ring-1 focus:ring-[#04413D] transition-all duration-200 bg-white"
                        />
                      </div>
                      <ErrorMessage
                        name="phoneNumber"
                      ...
                      <div className="flex gap-2">
                        <div className="relative w-24">
                          <select
                            ...
                            onChange={(e) =>
                              setSelectedWhatsappCountry(e.target.value)
                            }
                            className="w-full border  text-gray-700 border-gray-200 rounded-xl p-2 focus:outline-none focus:border-[#04413D] focus:ring-1 focus:ring-[#04413D] bg-white cursor-pointer appearance-none text-center font-medium text-sm"
                          >
                            {countryCodes.map((country) => (
                  ...
                  <div className="flex flex-col">
                    ...
                    <div
                      className={`relative transition-all duration-200 ${
                        isFocused.companyAddress ? "transform scale-[1.01]" : ""
                      }`}
                    >
                      <Field
                        as="textarea"
                  ...
                  <p className="text-center text-xs text-gray-400 mt-3 flex items-center justify-center gap-1">
                    ...
                    By submitting this form, you agree to our partnership terms
                    and privacy policy.
                  </p>
                </Form>
              )}
